...
var eventId = "F413452E-2109-4968-A990-A7E99D5DEED6";
...
var Superhero = {
	...
	getNotification: function (company) {
		...
		company.adjustHype(5 - 5 * company.getRandom());

		return new Notification({
			sourceId: eventId,
			header: "Superhero Disaster".localize(),
			text: msg,
			options: ["Call the police", "Ignore Situation", "Destroy Office"]
		});
	},
	complete: function (decision) {
		...
		if (decision === 2) {
			...
			n.adjustHype(5 - 20 * company.getRandom());
			company.activeNotifications.addRange(n.split()); 
			return;
			}
		}
...
var Cake = {
	...
	getNotification: function (company) {
		...
		return new Notification({
			...
			text: msg,
			options: ["Eat Cake", "Don't Eat Cake", "Cake is a Lie"]
		});
	},
	complete: function (decision) {
...
var eventId = "F514463G-2222-5000-B111-A9F11D7DEED7";
...
var National = {
	...
	getNotification: function (company) {
		...
		company.adjustHype(5 - 20 * company.getRandom());

		return new Notification({
			sourceId: eventId,
			header: "National Charlie Day!".localize(),
			text: msg,
			options: ["Work on Game Instead", "Go to Parade", "Don't go to Parade"]
		});
	},
	complete: function (decision) {
...
var GirlScouts = {
	...
	getNotification: function (company) {
		...
		return new Notification({
			...
			text: msg,
			options: ["Buy Cookies", "Ignore Them", "Don't buy cookies"]
		});
	},
	complete: function (decision) {
...
var eventId = "F514465G-2233-5002-B113-A9F12D8DEEE9";
...
var HypeGame = {
	...
	getNotification: function (company) {
		...
		return new Notification({
			...
			text: msg,
			options: ["Tell the reporter", "Don't tell the reporter"]
		});
	},
	complete: function (decision) {
	...
	var company = GameManager.company;
		...
		if (decision === 0) {
			...
			n.adjustHype(5 + 30 * company.getRandom());
